import numpy as np
# 应用于2D、3D
def PCA(points_tenser):
    points = points_tenser.cpu().detach().clone()
...
def build_obb(bone_vertices):
    corners, pcaCenter, pcaRadius,eigenvalue,eigenvector = PCA(bone_vertices)
